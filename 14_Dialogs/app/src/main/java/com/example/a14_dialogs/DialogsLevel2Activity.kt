...
import com.example.a14_dialogs.databinding.ActivityLevel2Binding
import com.example.a14_dialogs.databinding.PartVolumeBinding
import com.example.a14_dialogs.databinding.PartVolumeInputBinding
...
class DialogsLevel2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.showCustomAlertDialogButton.setOnClickListener(listenerCustomAlertDialogButton)
        binding.showCustomSingleChoiceAlertDialogButton.setOnClickListener(
            listenerCustomSingleChoiceAlertDialogButton
        )
        binding.showInputAlertDialogButton.setOnClickListener(listenerInputAlertDialogButton)
    ...
    private val listenerCustomAlertDialogButton = View.OnClickListener {
    ...
    private val listenerCustomSingleChoiceAlertDialogButton = View.OnClickListener {
    ...
    private val listenerInputAlertDialogButton = View.OnClickListener {
