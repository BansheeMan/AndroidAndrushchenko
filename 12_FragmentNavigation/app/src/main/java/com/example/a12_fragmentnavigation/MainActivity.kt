...
import com.example.a12_fragmentnavigation.contract.*
import com.example.a12_fragmentnavigation.databinding.ActivityMainBinding
import com.example.a12_fragmentnavigation.fragments.*
...
class MainActivity : AppCompatActivity(), Navigator {
    ...
    override fun showCongratulationsScreen() {
        launchFragment(BoxFragment.newInstance())
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        //инициирует первое появление переопределнного
        updateUi()
        return true
    }
    ...
    private fun updateUi() {
        ...
        with(binding) {
            ...
            if (supportFragmentManager.backStackEntryCount > 0) {
                ...
                supportActionBar?.setDisplayHomeAsUpEnabled(false) //TODO: search Google
